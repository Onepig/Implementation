'''
This module includes those basic classifieres of machine learning, such as, kNN, naive Bayes,
...
class AdaBoost:
    ...
    def loadDataSet(self,filename):
        ...
        lines=fr.readlines()
        fr.close()
        numFeat = len(lines) #get number of fields
        dataMat = []
        labelMat = []
        for line in lines:
            lineArr =[]
...
if __name__=="__main__":
    boost=AdaBoost()
    datMat, labelMat=boost.loadDataSet(r"E:\Study\Algorithm\Machine Learning\Python\machinelearninginaction\Ch07\horseColicTraining2.txt")
    N=shape(datMat)[0]
    classifierArray, egg=boost.adaBoostTrainDS(datMat, labelMat, 10)
    testArr, testLabelArr=boost.loadDataSet(r"E:\Study\Algorithm\Machine Learning\Python\machinelearninginaction\Ch07\horseColicTest2.txt")
